...
We did a think-aloud usability test to gather feedback regarding our prototype and got the following:

Users preferred the usage of visual and color cues as it helps with the user experience of the application. We plan to continue making use of colors and visual cues throughout the application.

When we designed the prototype, we used abbreviation for certain naming conventions, Many users found this confusing and we plan to avoid the use of abbreviation moving forward.

Users also wanted a sort functionality (something our current prototype lacks) to better aid when searching for a specific savings account.
